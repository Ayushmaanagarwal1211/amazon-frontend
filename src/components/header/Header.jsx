...
export default function Header() {
  ...
  return (
    <div className='flex  relative gap-0 min-h-[84vh]  h-[84vh] max-lg:h-auto  flex-row w-[100%] overflow-x-hidden overflow-y-hidden max:lg-overflow-y-visible  '>
        <div className='right-arrow absolute  right-0 z-[100] top-[30%] max-lg:top-[50px] flex justify-center items-center '>{<FaArrowRight onClick={()=>handleChangeImage(currImage+1)} size={"2rem"}/>}</div>
        <div className='right-arrow absolute  left-0 z-[100] top-[30%] max-lg:top-[50px] flex justify-center items-center '>{<FaArrowLeft onClick={()=>handleChangeImage(currImage-1)} size={"2rem"}/>}</div>
        {
        ...
        <div className='w-[100%] h-auto  !important relative top-[40%] max-lg:top-[100px] max-lg:flex-wrap  p-2 flex gap-6 justify-center '>
